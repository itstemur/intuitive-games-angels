 ...
 */
public class FrgOrderDocuments extends Fragment implements BaseClass, DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            fillDocContentTypeSpinner(getActivity(), new JSONArray(), getResources().getString(R.string.type));
            fillArtTypeSpinner(getActivity(), new JSONArray(), getResources().getString(R.string.typeArt));
            fillSubTypeSpinner(getActivity(), new JSONArray(), getResources().getString(R.string.SubtypeArt));
    ...
    public void onResume() {
        ...
        Dashboard.tvTitle.setText("Dokument hinzufügen");
        super.onResume();
    }
    ...
    private void getSubArtType() {
        try {
            HashMap<String, String> postDataParams = new HashMap<>();
            HttpConnection httpConnection = new HttpConnection(delegate, getActivity());
            postDataParams.put("docoFK_TlkpDocTypes", getArtTypeID());
            httpConnection.setRequestedfor("getSubArtType");
            httpConnection.setIsloading(false);
    ...
    private void fillSubTypeSpinner(Context context, JSONArray rows, String mFirstRow) throws Exception {
    ...
    private void save() {
        try {
            ...
            postDataParams.put("FK_RelationId", Common.selectedOrderDetail.getString("OrderNr"));
            Log.i(TAG, "Auftrag Nr:" + Common.selectedOrderDetail.getString("OrderNr"));
            postDataParams.put("CallingDataType", "Order");
            ...
            HttpConnection httpConnection = new HttpConnection(delegate, getActivity());
            httpConnection.setRequestedfor("SaveDocument");
            httpConnection.setIsloading(true);
            httpConnection.setPostDataParams(postDataParams);
            httpConnection.setUrl("Orders/SaveDocument");
            httpConnection.execute("");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (requestedFor.equals("getSubArtType")) {
            {
                ...
                if (jSubArtObj.getString("ResultCode").equals("SUCCESS")) {
                    ...
                    fillSubTypeSpinner(getActivity(), jArrayArtList, getResources().getString(R.string.SubtypeArt));
                } else {
