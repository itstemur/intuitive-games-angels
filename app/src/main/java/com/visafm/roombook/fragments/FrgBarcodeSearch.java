...
/**
 * Created by Ankit on 4/3/2017.
 */
public class FrgBarcodeSearch extends Fragment implements BaseClass {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.frg_barcode_search, container, false);
    ...
    public void onResume() {
        ...
        etBarcode.setText(Common.BARCODE_STRING);
        super.onResume();
    }
    ...
    private void createOrder() {
        try {
            ...
            postDataParams.put("barcode", etBarcode.getText().toString());
            HttpConnection httpConnection = new HttpConnection(delegate, getActivity());
            httpConnection.setRequestedfor("barcodesearch");
            httpConnection.setIsloading(true);
            httpConnection.setPostDataParams(postDataParams);
            httpConnection.setUrl("Orders/GetAssignOrdersByAusstattungID");
        ...
        try {
            ...
            if (requestedFor.equals("barcodesearch")) {
                ...
                if (jObj.getString("ResultCode").equals("SUCCESS")) {
                    jArrayOrderTemp = jObj.getJSONArray("ResultObject");
                    Common.setSharedPreferences(getActivity(), "barcodesearchResult", jArrayOrderTemp.toString());
                    Dashboard.displayFragment(7);
    ...
    private void showAlert() {
        ...
        alertDialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "ZULASSEN",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(getActivity(),
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(android.app.AlertDialog.BUTTON_POSITIVE, "EINSTELLUNGEN",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
